...
- **URL:** `/`
- **Page title:** `SNC Media — Performance-маркетинг для ecommerce-брендов`
...
- **OG title:** `SNC Media — Performance, без театра.`
- **OG description:** `Meta ads для ecommerce. Senior-исполнение, прозрачная отчётность, асинхронный формат работы.`
- **OG image:** brand cover (green canvas + S mark + "SNC Media" wordmark, 1200×630)
...
- **Copy:**
  - Top-left label (9px, tracked, white/60%): `SNC MEDIA · PERFORMANCE`
...
- **Background:** Deep Forest `#0F2A20`.
- **Contents:**
  - Logo (S-mark + SNC Media wordmark, muted white)
  - Three columns:
    - Услуги: Meta Ads (ecommerce), Meta Ads (lead-gen), Креатив
    - Компания: Подход, Кейсы, Контакт
    - Связь: Telegram, Email
  - Bottom rule line
  - Bottom row: `© 2026 SNC Media · Riga / EU` left, `IBM Plex Mono · #1E4D3A` right
